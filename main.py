...
username_entry =Entry(window,bd=0, width=10,font=('comic sans', 17, 'normal'),bg="#ffffff")
username_entry.insert(0,"username")
username_entry.place(x=435,y=125)
password_entry =Entry(window,bd=0, width=10,font=('comic sans', 17, 'normal'),bg="#ffffff")
